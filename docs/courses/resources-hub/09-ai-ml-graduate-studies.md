...
<div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 2rem; border-radius: 10px; color: white; margin-bottom: 2rem;">
  <h2 style="margin: 0; color: white;">🎓 AI & ML Graduate Studies Resources</h2>
  <p style="margin: 1rem 0 0 0;">Resources for MTech, Master's, and PhD programs in Artificial Intelligence and Machine Learning.</p>
</div>
...
??? "Core ML/AI Textbooks"
    ...
    4. [Elements of Statistical Learning by Hastie, Tibshirani, Friedman](https://web.stanford.edu/~hastie/ElemStatLearn/) - Springer (Free PDF)
    5. [Information Theory, Inference and Learning Algorithms by David MacKay](http://www.inference.org.uk/mackay/itila/) - Cambridge (Free PDF)
...
??? "Top ML/AI Journals & Conferences"
    ...
    4. [JMLR Journal](https://www.jmlr.org/) - Journal of Machine Learning Research (Free)
    5. [arXiv Machine Learning](https://arxiv.org/list/cs.LG/recent) - Latest ML papers
    6. [arXiv Artificial Intelligence](https://arxiv.org/list/cs.AI/recent) - Latest AI papers
...
??? "Academic ML Repos"
    ...
    4. [ML From Scratch](https://github.com/eriklindernoren/ML-From-Scratch) - Implementations from scratch
    5. [PyTorch Official](https://github.com/pytorch/pytorch) - Research framework
    6. [TensorFlow Research](https://github.com/tensorflow/models) - Research models
...
??? "Top University ML/AI Courses"
    ...
    4. [CMU 10-701: Introduction to Machine Learning](https://www.cs.cmu.edu/~epxing/Class/10701/) - Carnegie Mellon
    5. [Berkeley CS188: Artificial Intelligence](https://www.youtube.com/playlist?list=PLIeooNSdhQE5vR1XQaX4jqJ7Fz0k8l1oF) - UC Berkeley
    6. [Deep Learning Specialization (Coursera)](https://www.coursera.org/specializations/deep-learning) - Andrew Ng
...
??? "MTech/Master's Resources"
    ...
    4. [Berkeley EECS Graduate](https://eecs.berkeley.edu/academics/graduate) - UC Berkeley programs
    5. [Top ML Master's Programs Guide](https://www.mastersindatascience.org/specializations/machine-learning/) - Program guide
...
??? "PhD Research Resources"
    ...
    4. [Research Methodology in ML](https://www.cs.cmu.edu/~tom/10701_sp11/lectures.shtml) - Research methods
    5. [PhD Thesis Examples](https://github.com/terryum/awesome-deep-learning-papers) - Research papers
...
??? "Academic Research Blogs"
    ...
    4. [Jay Alammar's Blog](http://jalammar.github.io/) - ML visualizations
    5. [Sebastian Ruder's Blog](https://ruder.io/) - NLP research
    6. [Christopher Olah's Blog](https://colah.github.io/) - Neural network visualizations
...
??? "Academic Research Tools"
    ...
    4. [Connected Papers](https://www.connectedpapers.com/) - Research paper graphs
    5. [arXiv Sanity Preserver](http://www.arxiv-sanity.com/) - Paper discovery
...
??? "Top ML/AI Research Labs"
    ...
    4. [CMU Machine Learning Department](https://www.ml.cmu.edu/) - CMU ML
    5. [DeepMind](https://www.deepmind.com/research) - Google DeepMind
    6. [OpenAI Research](https://openai.com/research/) - OpenAI
...
??? "Thesis Writing Resources"
    ...
    4. [How to Read a Paper](https://web.stanford.edu/class/ee384m/Handouts/HowtoReadPaper.pdf) - Paper reading guide (PDF)
...
??? "More Resources"
    ...
    4. [ML Conferences Calendar](https://aideadlin.es/) - Conference deadlines
    5. [Graduate School Application Resources](https://www.cs.cmu.edu/~harchol/gradschooltalk.pdf) - Application guide
